...
import { OPENMODAL, OPENTOP, OPENMODAL2, OPENTOP2, PAGELOCATION, TOGGLESAVE, WEAPONMODAL, WEAPONMODAL2, ROLLINIT, HIDEFIGHTER, INPUTHEALTH, INPUTFATIGUE, TOGGLEPLAYERVIEW } from '../ducks/reducer'
...
let actionBuilder = {
    LOADCOMBATANTS, KILLCOMBATANT, REMOVEFIGHTER, ADVANCESPEED, INPUTACTION, OPENMODAL, OPENTOP, OPENMODAL2, OPENTOP2, GETALLSTATUSES, PAGELOCATION, TOGGLESAVE, GETHASH, WEAPONMODAL, WEAPONMODAL2, ROLLINIT, HIDEFIGHTER, INPUTHEALTH, INPUTFATIGUE, TOGGLEPLAYERVIEW
}
